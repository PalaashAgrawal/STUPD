...
class DRNet(nn.Module):
    def __init__(self, word_embedding_dim, feature_dim, num_classes, num_layers=3, imagenet_pretrained:bool = True):
        ...
        self.appr_module = models.__dict__['resnet18'](weights=weights)
